...
import type { NgFlexDialogRootComponent } from "../components/dialog/root/root.component";
import { NgFlexDialogInstance } from "../services/DialogInstance";

@Injectable({ providedIn: 'root' })
export class NgFlexDialogInternal {
  ...
  readonly root = signal<NgFlexDialogRootComponent | null>(null);
